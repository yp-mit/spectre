...
c = struct('name', 'Polar+CRC R=1/2 (L=32)', 'ebno', 1.59, 'n', 4096, 'k', 2048, 'pe', 1e-4, 'fname', 'polar4', 'comment', 'The exact code: Vardy-Tal list-decoded polar+CRC');
CODES = [CODES c];

c = struct('name', 'Polar+CRC R=1/2 (L=32)', 'ebno', 1.8283, 'n', 2048, 'k', 1024, 'pe', 1e-4, 'fname', 'polar2', 'comment', 'The exact code: Vardy-Tal list-decoded polar+CRC');
CODES = [CODES c];

c = struct('name', 'Polar+CRC R=1/2 (L=32)', 'ebno', 2.09063, 'n', 1024, 'k', 512, 'pe', 1e-4, 'fname', 'polar1', 'comment', 'The exact code: Vardy-Tal list-decoded polar+CRC');
CODES = [CODES c];

c = struct('name', 'Polar+CRC R=1/2 (L=32)', 'ebno', 2.5, 'n', 512, 'k', 256, 'pe', 1e-4, 'fname', 'polar0', 'comment', 'The exact code: Vardy-Tal list-decoded polar+CRC');
CODES = [CODES c];

c = struct('name', 'Polar+CRC R=1/2 (L=256)', 'ebno', 2.25, 'n', 512, 'k', 256, 'pe', 1e-4, 'fname', 'polar5', 'comment', 'The exact code: Vardy-Tal list-decoded polar+CRC');
CODES = [CODES c];
