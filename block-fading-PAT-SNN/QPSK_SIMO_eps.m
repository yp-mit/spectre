function epsilon = QPSK_SIMO_eps(Mr, k, L, nc, fp, SNR_dB, spa)
% QPSK_SIMO_EPS
% 
% Inputs
...
% System parameters
%nc = 12*sps*cpcb;       % degrees of freedom per coherence band
n = L * nc;             % blocklength
R = k/n;                % rate (bits)
...
eps_trial = eps_RCUs_stable(R, Mr, L, np, nc, rho, spa, RELSPREAD_MAX);
