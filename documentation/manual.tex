...
\item \verb|en0| or \verb|EE| -- input/output argument; total energy budget available $E\over N_0$ (to get ${E_b\over
...
\includegraphics[height=2in]{plots/energy_awgn}
%\includegraphics[height=2in]{plots/energy_fading}
