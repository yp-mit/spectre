...
\item \verb|en0| -- input/output argument; energy-per-bit $E_b\over N_0$.
\item \verb|EE| -- input argument; total energy budget available $E\over N_0$ (to get ${E_b\over N_0}$).
\end{enumerate}
\end{itemize}
...
Note that \verb|en0| is the $E_b\over N_0$ (i.e. energy-per-bit, \textit{not} total energy budget).
